...
|-------|-------------|
| **ID** | CU-001 |
| **Nombre** | visualizar menu |
| **Actores** | usuario, chef |
| **Descripción** | permite informarse sobre los distintos platillos que dispone el local, para empezar otros procedimientos como: pedir producto |
| **Precondiciones** | 1. el usuario ingresa al localQR<br>2. el usuario muestra el carnet Al<br>3. el usuario escanea el codigo QR<br>4. visiviliza el menu |
| **Postcondiciones** | 1. el carnet es verificado<br>2. al usuario se le redirigira a una pagina diferente<br>3. en la nueva pagina visualizara el menu<br>4.La pagina no funcionara(opcional) |
