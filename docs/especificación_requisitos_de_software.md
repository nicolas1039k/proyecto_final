...
| **ID** | CU-001 |
| **Nombre** | mirar menu|
| **Actores** | chef (primario), Usuario ddl restaurante (secundario) |
| **Descripción** | Permite al usuario visualizar el menu, para seguidamente hacer tareas como:hacer una orden |
| **Precondiciones** | 1. Al usuario le fue validado su carnet<br>2. el usuario escanea el código QR con su aparato electrónico |
| **Postcondiciones** | 1. El usuario debe ser redirigido a una nueva pestańa<br>2. En la nueva pestańa, el usuario debe poder ver el menu|
| **Flujo Principal** | 1. El usuario escanea su carnet <br> 2. El carnet es validado <br> 3. El usuario escanea el código QR con su aparato electronico <br> 4. El usuario es redirigido a una nueva pestańa<br> 5. El usuario hace su pedido|
| **Flujos Alternativos** | **4a. carnet denegado**:<br>  4a1.  El sistema mostrará el mensaje "**carnet denegado**"<br><br>**7a. página caida**:<br>  7a1. el usuario al escanea el código le parecerá **"pagina no encontrada"**<br>  7a2.  El sistema ofrecerá la opción de **"informar problema"**<br>  7a3. Si el usuario toca el botón antes mencionado el sistema informará a un encargado<br>  7a4. el sistems funcionará lo antes posible |
| **Flujos de Excepción** | **5a. Usuario suspendido o con multas vencidas**:<br>  5a1. El sistema muestra advertencia "Usuario suspendido" o "Usuario tiene multas vencidas por $[monto]"<br>  5a2. El sistema NO permite continuar con el préstamo<br>  5a3. El sistema ofrece opción "Registrar pago de multa"<br>  5a4. Fin del caso de uso<br> |
| **Requisitos Relacionados** | RF-030 (Validar carnet)<br>RF-031 (Escaneo exitoso del QR)<br>RF-032 (IntegridadIntegridad de los datos del usuario)<br>RNFR-001 (Tiempo de respuesta) |
<br>
